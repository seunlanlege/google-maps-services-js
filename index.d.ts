...
type GoogleMapsClientEndpoint<Request, Response> = (
	query: Request,
 ...
 */
export type TravelMode /** (default) indicates standard driving directions using the road network. */ =
	| 'driving'
...
export type TravelRestriction /** indicates that the calculated route should avoid toll roads/bridges. */ =
	| 'tolls'
 ...
 */
export type UnitSystem /** specifies usage of the metric system. Textual distances are returned using kilometers and meters. */ =
	| 'metric'
...
export type TransitMode /** indicates that the calculated route should prefer travel by bus. */ =
	| 'bus'
...
export type TransitRoutingPreference /** indicates that the calculated route should prefer limited amounts of walking. */ =
	| 'less_walking'
 ...
 */
export type DirectionsReponseStatus /** indicates the response contains a valid `result`. */ =
	| 'OK'
...
export type GeocodedWaypointStatus /** indicates that no errors occurred; the address was successfully parsed and at least one geocode was returned. */ =
	| 'OK'
	/**
...
export type AddressType /** indicates a precise street address. */ =
	| 'street_address'
 ...
 */
export type DistanceMatrixResponseTopLevelStatus /** indicates the response contains a valid result. */ =
	| 'OK'
...
export type DistanceMatrixResponseElementLevelStatus /** indicates the response contains a valid result. */ =
	| 'OK'
...
export type ElevationResponseStatus /** indicating the API request was successful. */ =
	| 'OK'
...
export interface FindPlaceRequest {
	 ...
	 */
	fields?: (keyof PlaceSearchResult)[]
	/**
 ...
 */
export type SearchResponseStatus /** indicates that no errors occurred; the place was successfully detected and at least one result was returned. */ =
	| 'OK'
	/**
 ...
 */
export type GeocodingResponseStatus /** indicates that no errors occurred; the address was successfully parsed and at least one geocode was returned. */ =
	| 'OK'
	/**
	 * indicates that the geocode was successful but returned no results.
	 * This may occur if the geocoder was passed a non-existent `address`.
...
export type GeocodingAddressComponentType /** indicates the floor of a building address. */ =
	| 'floor'
 ...
 */
export type PlaceDetailsResponseStatus /** indicates that no errors occurred; the place was successfully detected and at least one result was returned. */ =
	| 'OK'
	/** indicates a server-side error; trying again may be successful. */
	| 'UNKNOWN_ERROR'
	/**
 ...
 */
export type PlaceAutocompleteResponseStatus /** indicates that no errors occurred and at least one result was returned. */ =
	| 'OK'
	/**
	 * indicates that the search was successful but returned no results.
 ...
 * and may contain debugging information to help you track down why the request failed.
 */
export type QueryAutocompleteResponseStatus /** indicates that no errors occurred and at least one result was returned. */ =
	| 'OK'
	/**
	 * indicates that the search was successful but returned no results.
	 * This may occur if the search was passed a bounds in a remote location.
...
export type ReverseGeocodingLocationType /** returns only the addresses for which Google has location information accurate down to street address precision. */ =
	| 'ROOFTOP'
	/**
 ...
 */
export type ReverseGeocodingResponseStatus /** indicates that no errors occurred and at least one address was returned. */ =
	| 'OK'
	/**
...
export type TimeZoneResponseStatus /** indicates that the request was successful. */ =
	| 'OK'
